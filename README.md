[![Run App JohnDelfosse](https://github.com/JohnDelfosse/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/JohnDelfosse/GithubActions/actions/workflows/run-app.yaml)
