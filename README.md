[![Run App Eldin Salja](https://github.com/EldinSalja/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/EldinSalja/GithubActions/actions/workflows/run-app.yaml)
