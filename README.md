[![Run App Gupil_Kodali](https://github.com/GupKodali/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/GupKodali/GithubActions/actions/workflows/run-app.yaml)
