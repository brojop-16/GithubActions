[![Run App JonathanSkelton](https://github.com/Jonny-Skelton/GithubActionsLab/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Jonny-Skelton/GithubActionsLab/actions/workflows/run-app.yaml)
