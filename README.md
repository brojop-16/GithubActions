[![Run App JakeAn](https://github.com/Getting-good/GithubActionsLab/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Getting-good/GithubActionsLab/actions/workflows/run-app.yaml)
