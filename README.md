[![Run App Colton Hill](https://github.com/Chill55/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Chill55/GithubActions/actions/workflows/run-app.yaml)
