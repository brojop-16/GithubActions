[![Run App Adrien](https://github.com/Adrien-Palomo/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Adrien-Palomo/GithubActions/actions/workflows/run-app.yaml)
