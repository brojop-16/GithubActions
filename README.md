[![Run App DaneTroia](https://github.com/DaneTroia/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/DaneTroia/GithubActions/actions/workflows/run-app.yaml)
