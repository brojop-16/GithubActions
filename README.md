[![Run App AlexBusch](https://github.com/abusch8/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/abusch8/GithubActions/actions/workflows/run-app.yaml)
