[![Run App JackRankin](https://github.com/jackrankin/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/jackrankin/GithubActions/actions/workflows/run-app.yaml)
