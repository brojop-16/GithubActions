[![Run App](https://github.com/ecthelionvi/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ecthelionvi/GithubActions/actions/workflows/run-app.yaml)
